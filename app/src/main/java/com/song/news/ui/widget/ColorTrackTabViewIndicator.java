package com.song.news.ui.widget;
...
import com.song.news.utils.ViewAttributeUtil;
...
public class ColorTrackTabViewIndicator extends HorizontalScrollView implements ColorUiInterface {
    ...
    public ColorTrackTabViewIndicator(Context context, AttributeSet attrs,
        ...
        mTabSelectedTextColor = ta.getColor(R.styleable.ColorTrackTabViewIndicator_ctTabSelectedTextColor,
                Color.YELLOW);
        mAttr_selectedTextColor = ViewAttributeUtil.getAttributeValue(attrs, R.attr.ctTabSelectedTextColor);

        mTabTextSize = (int) ta.getDimension(R.styleable.ColorTrackTabViewIndicator_ctTabTextSize,
                sp2px(getContext(), 14));
        ...
        mTabStrip.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
            ...
            tabLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ColorTrackView colorTrackView =
                            (ColorTrackView) ((LinearLayout) mTabStrip.getChildAt(index))
                            .getChildAt(0);
